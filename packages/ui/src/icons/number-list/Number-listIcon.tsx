...
export interface Number-listIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  size?: number | string;
  color?: string;
}

export const Number-listIcon = ({ 
  size = 24, 
  color = 'currentColor',
  ...props 
}: Number-listIconProps) => {
  return (
    <svg
      width={size}
      height={size}
