...
export interface TextAlign-centerIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  size?: number | string;
  color?: string;
}

export const TextAlign-centerIcon = ({ 
  size = 24, 
  color = 'currentColor',
  ...props 
}: TextAlign-centerIconProps) => {
  return (
    <svg
      width={size}
      height={size}
