...
export interface List-viewIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  size?: number | string;
  color?: string;
}

export const List-viewIcon = ({ 
  size = 24, 
  color = 'currentColor',
  ...props 
}: List-viewIconProps) => {
