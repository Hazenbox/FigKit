...
export interface AlSpacing-verticalIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  size?: number | string;
  color?: string;
}

export const AlSpacing-verticalIcon = ({ 
  size = 24, 
  color = 'currentColor',
  ...props 
}: AlSpacing-verticalIconProps) => {
  return (
    <svg
      width={size}
      height={size}
