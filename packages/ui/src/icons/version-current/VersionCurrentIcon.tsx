...
export interface VersionCurrentIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  size?: number | string;
  color?: string;
}

export const VersionCurrentIcon = ({ 
  size = 24, 
  color = 'currentColor',
  ...props 
}: VersionCurrentIconProps) => {
  return (
    <svg
      width={size}
      height={size}
