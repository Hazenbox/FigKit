...
export interface TextAlign-leftIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  size?: number | string;
  color?: string;
}

export const TextAlign-leftIcon = ({ 
  size = 24, 
  color = 'currentColor',
  ...props 
}: TextAlign-leftIconProps) => {
  return (
    <svg
      width={size}
      height={size}
