...
export interface KeyboardShortcutsSmallIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  size?: number | string;
  color?: string;
}

export const KeyboardShortcutsSmallIcon = ({ 
  size = 24, 
  color = 'currentColor',
  ...props 
}: KeyboardShortcutsSmallIconProps) => {
  return (
    <svg
      width={size}
      height={size}
