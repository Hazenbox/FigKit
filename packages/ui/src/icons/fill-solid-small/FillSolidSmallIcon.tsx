...
export interface FillSolidSmallIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  size?: number | string;
  color?: string;
}

export const FillSolidSmallIcon = ({ 
  size = 24, 
  color = 'currentColor',
  ...props 
}: FillSolidSmallIconProps) => {
  return (
    <svg
      width={size}
      height={size}
