...
export interface BooleanSmallIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  size?: number | string;
  color?: string;
}

export const BooleanSmallIcon = ({ 
  size = 24, 
  color = 'currentColor',
  ...props 
}: BooleanSmallIconProps) => {
  return (
    <svg
      width={size}
      height={size}
