...
export interface ActionGoSmallIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  size?: number | string;
  color?: string;
}

export const ActionGoSmallIcon = ({ 
  size = 24, 
  color = 'currentColor',
  ...props 
}: ActionGoSmallIconProps) => {
  return (
    <svg
      width={size}
      height={size}
