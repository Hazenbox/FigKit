...
export interface AlSpacing-horizontalIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  size?: number | string;
  color?: string;
}

export const AlSpacing-horizontalIcon = ({ 
  size = 24, 
  color = 'currentColor',
  ...props 
}: AlSpacing-horizontalIconProps) => {
  return (
    <svg
      width={size}
      height={size}
