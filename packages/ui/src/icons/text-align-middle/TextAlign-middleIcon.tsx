...
export interface TextAlign-middleIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  size?: number | string;
  color?: string;
}

export const TextAlign-middleIcon = ({ 
  size = 24, 
  color = 'currentColor',
  ...props 
}: TextAlign-middleIconProps) => {
  return (
    <svg
      width={size}
      height={size}
