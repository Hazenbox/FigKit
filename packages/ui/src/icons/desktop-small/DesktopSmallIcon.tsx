...
export interface DesktopSmallIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  size?: number | string;
  color?: string;
}

export const DesktopSmallIcon = ({ 
  size = 24, 
  color = 'currentColor',
  ...props 
}: DesktopSmallIconProps) => {
  return (
    <svg
      width={size}
      height={size}
