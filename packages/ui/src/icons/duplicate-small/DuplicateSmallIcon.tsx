...
export interface DuplicateSmallIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  size?: number | string;
  color?: string;
}

export const DuplicateSmallIcon = ({ 
  size = 24, 
  color = 'currentColor',
  ...props 
}: DuplicateSmallIconProps) => {
  return (
    <svg
      width={size}
      height={size}
