...
export interface FlipHorizontalSmallIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  size?: number | string;
  color?: string;
}

export const FlipHorizontalSmallIcon = ({ 
  size = 24, 
  color = 'currentColor',
  ...props 
}: FlipHorizontalSmallIconProps) => {
  return (
    <svg
      width={size}
      height={size}
