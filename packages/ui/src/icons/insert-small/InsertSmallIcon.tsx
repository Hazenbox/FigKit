...
export interface InsertSmallIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  size?: number | string;
  color?: string;
}

export const InsertSmallIcon = ({ 
  size = 24, 
  color = 'currentColor',
  ...props 
}: InsertSmallIconProps) => {
  return (
    <svg
      width={size}
      height={size}
