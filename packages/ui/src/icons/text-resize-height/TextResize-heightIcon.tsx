...
export interface TextResize-heightIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  size?: number | string;
  color?: string;
}

export const TextResize-heightIcon = ({ 
  size = 24, 
  color = 'currentColor',
  ...props 
}: TextResize-heightIconProps) => {
  return (
    <svg
      width={size}
      height={size}
